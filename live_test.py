...
from sendgrid.helpers.mail import From, HtmlContent, Mail, PlainTextContent, SendGridException, Subject, To

message = Mail(
    from_email=From("help@twilio.com", "Twilio SendGrid"),
...
to_emails = [To("ethomas@twilio.com", "Elmer SendGrid"), To("elmer.thomas@gmail.com", "Elmer Thomas")]
message = Mail(from_email=From("help@twilio.com", "Twilio SendGrid"), to_emails=to_emails, subject=Subject("Sending with SendGrid is Fun"), plain_text_content=PlainTextContent("and easy to do anywhere, even with Python"), html_content=HtmlContent("<strong>and easy to do anywhere, even with Python</strong>"))
...
from sendgrid import SendGridAPIClient
from sendgrid.helpers.mail import From, HtmlContent, Mail, PlainTextContent, SendGridException, Subject, Substitution, To
...
message.to = [To("elmer+test2@sendgrid.com", "Example User2", p=0), To("elmer+test3@sendgrid.com", "Example User3", p=0)]
...
message.attachment = Attachment(FileContent("base64 encoded content 1"), FileType("application/pdf"), FileName("balance_001.pdf"), Disposition("attachment"), ContentId("Content ID 1"))
message.attachment = [
    Attachment(FileContent("base64 encoded content 2"), FileType("image/png"), FileName("banner.png"), Disposition("inline"), ContentId("Content ID 2")),
    Attachment(FileContent("base64 encoded content 3"), FileType("image/png"), FileName("banner2.png"), Disposition("inline"), ContentId("Content ID 3")),
]
...
from sendgrid import SendGridAPIClient
from sendgrid.helpers.mail import DynamicTemplateData, From, HtmlContent, Mail, PlainTextContent, SendGridException, Subject, To
