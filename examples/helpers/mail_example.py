...
def get_mock_personalization_dict():
    ...
    mock_pers["to_list"] = [To("test1@example.com", "Example User"), To("test2@example.com", "Example User")]

    mock_pers["cc_list"] = [To("test3@example.com", "Example User"), To("test4@example.com", "Example User")]

    mock_pers["bcc_list"] = [To("test5@example.com"), To("test6@example.com")]

    mock_pers["subject"] = "Hello World from the Personalized SendGrid Python Library"

    mock_pers["headers"] = [Header("X-Test", "test"), Header("X-Mock", "true")]

    mock_pers["substitutions"] = [Substitution("%name%", "Example User"), Substitution("%city%", "Denver")]

    mock_pers["custom_args"] = [CustomArg("user_id", "343"), CustomArg("type", "marketing")]
...
def build_multiple_emails_personalized():
    ...
    message = Mail(from_email=From("from@example.com", "Example From Name"), subject=Subject("Sending with SendGrid is Fun"), plain_text_content=PlainTextContent("and easy to do anywhere, even with Python"), html_content=HtmlContent("<strong>and easy to do anywhere, even with Python</strong>"))
...
def build_attachment1():
    ...
    attachment.file_content = "TG9yZW0gaXBzdW0gZG9sb3Igc2l0IGFtZXQsIGNvbnNlY3RldHVyIGFkaXBpc2NpbmcgZWxpdC4gQ3JhcyBwdW12"
...
def build_kitchen_sink():
    ...
    message.to = [To("test2@sendgrid.com", "Example User2", p=0), To("test3@sendgrid.com", "Example User3", p=0)]
